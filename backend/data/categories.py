...
CATEGORY_KEYWORDS = {
    ...
    'medicine': ['medicine', 'tablet', 'capsule', 'syrup', 'ointment', 'cream', 'drops', 'inhaler', 'bandage', 'sanitizer', 'paracetamol', 'citrizine', 'crocin', 'disprin', 'dolo', 'vitamin', 'supplement', 'first aid'],
