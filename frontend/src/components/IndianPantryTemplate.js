  ...
  '🛒 GROCERY (किराणा)': {
    '🌾 Grains, Rice, Rava & Cereals': {
      ...
      items: [
        ...
        { en: 'Kolam Rice', mr: 'कोलम तांदूळ' },
        { en: 'Sona Masoori Rice', mr: 'सोना मसूरी तांदूळ' },
        ...
        { en: 'Maida', mr: 'मैदा' },
        { en: 'Jowar (Sorghum)', mr: 'ज्वारी' },
        { en: 'Jowar Flour', mr: 'ज्वारीचे पीठ' },
        { en: 'Bajra (Pearl Millet)', mr: 'बाजरी' },
        { en: 'Bajra Flour', mr: 'बाजरीचे पीठ' },
        { en: 'Ragi (Finger Millet)', mr: 'नाचणी' },
        { en: 'Ragi Flour', mr: 'नाचणी पीठ' },
        { en: 'Barley', mr: 'जव' },
        { en: 'Oats', mr: 'ओट्स' },
        { en: 'Quinoa', mr: 'क्विनोआ' },
        { en: 'Amaranth (Rajgira)', mr: 'राजगिरा' },
        { en: 'Buckwheat', mr: 'कुट्टू' },
        { en: 'Foxtail Millet (Kangni)', mr: 'कांगणी / राळा' },
        { en: 'Little Millet (Kutki)', mr: 'कुटकी / वरी' },
        { en: 'Kodo Millet', mr: 'कोदो' },
        { en: 'Barnyard Millet', mr: 'भगर' },
        { en: 'Proso Millet', mr: 'वरी तांदूळ' },
        { en: 'Maize (Corn)', mr: 'मका' },
        { en: 'Corn Flour (Makai Atta)', mr: 'मक्याचे पीठ' },
  ...
  '🧹 CLEANING & HOUSEHOLD (सफाई)': {
    ...
    '✨ Other Household Essentials': {
      ...
      items: [
        ...
        { en: 'Naphthalene Balls', mr: 'नॅप्थलीन गोळ्या' },
        { en: 'Camphor (Kapoor)', mr: 'कापूर' },
