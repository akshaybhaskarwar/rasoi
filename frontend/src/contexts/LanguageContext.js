...
export const UI_LABELS = {
  en: {
    ...
    // Restock planner & buying frequency
    planRestock: 'Plan restock',
    restockHint: 'Ticked items are marked empty and land on your shopping list.',
    freqMonthly: 'Monthly',
    freqYearly: 'Yearly',
    ...
    clearAll: 'Clear all',
    changeLabel: 'Change',
    boughtRecently: 'bought recently',
    snoozedTag: 'snoozed',
    alreadyEmptyTag: 'already empty',
    markEmptyCount: 'Mark {n} empty',
    nothingSelected: 'Nothing selected',
    nothingHere: 'No items here',
    checkingPantry: 'Checking your pantry…',
    markedEmptyToast: '{n} items marked empty',
    goesToShoppingList: 'They will show up in your shopping list.',
    undoLabel: 'Undo',
    stockRestored: 'Stock levels restored',
    monthEndTitle: 'New month coming up',
    monthEndHint: 'Plan your restock so finished staples land on the shopping list.',
    notNow: 'Not now',
  ...
  hi: {
    ...
    // Restock planner & buying frequency
    planRestock: 'खरीदारी की तैयारी',
    restockHint: 'चुनी हुई वस्तुएं खाली होंगी और खरीदारी सूची में आएंगी।',
    freqMonthly: 'मासिक',
    freqYearly: 'वार्षिक',
    freqAsNeeded: 'ज़रूरत पर',
    selectAll: 'सभी चुनें',
    clearAll: 'सभी हटाएं',
    changeLabel: 'बदलें',
    boughtRecently: 'हाल में खरीदा',
    snoozedTag: 'स्थगित',
    alreadyEmptyTag: 'पहले से खाली',
    markEmptyCount: '{n} खाली करें',
    nothingSelected: 'कुछ चुना नहीं',
    nothingHere: 'यहां कोई वस्तु नहीं',
    checkingPantry: 'आपकी रसोई देख रहे हैं…',
    markedEmptyToast: '{n} वस्तुएं खाली की गईं',
    goesToShoppingList: 'वे आपकी खरीदारी सूची में दिखेंगी।',
    undoLabel: 'पूर्ववत करें',
    stockRestored: 'स्टॉक वापस आ गया',
    monthEndTitle: 'नया महीना आ रहा है',
    monthEndHint: 'खत्म हुई वस्तुओं को खरीदारी सूची में लाने के लिए तैयारी करें।',
    notNow: 'अभी नहीं',
  ...
  mr: {
    ...
    // Restock planner & buying frequency
    planRestock: 'खरेदीची तयारी',
    restockHint: 'निवडलेल्या वस्तू रिकाम्या होतील आणि खरेदी यादीत येतील.',
    freqMonthly: 'मासिक',
    freqYearly: 'वार्षिक',
    freqAsNeeded: 'गरजेनुसार',
    selectAll: 'सर्व निवडा',
    clearAll: 'सर्व काढा',
    changeLabel: 'बदला',
    boughtRecently: 'नुकतेच घेतले',
    snoozedTag: 'पुढे ढकलले',
    alreadyEmptyTag: 'आधीच रिकामे',
    markEmptyCount: '{n} रिकाम्या करा',
    nothingSelected: 'काही निवडले नाही',
    nothingHere: 'इथे वस्तू नाहीत',
    checkingPantry: 'तुमचा साठा तपासत आहोत…',
    markedEmptyToast: '{n} वस्तू रिकाम्या केल्या',
    goesToShoppingList: 'त्या तुमच्या खरेदी यादीत दिसतील.',
    undoLabel: 'पूर्ववत करा',
    stockRestored: 'साठा पूर्ववत झाला',
    monthEndTitle: 'नवीन महिना येत आहे',
    monthEndHint: 'संपलेल्या वस्तू खरेदी यादीत आणण्यासाठी तयारी करा.',
    notNow: 'आत्ता नाही',
